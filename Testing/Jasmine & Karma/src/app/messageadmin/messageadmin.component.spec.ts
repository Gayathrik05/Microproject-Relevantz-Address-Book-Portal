...
describe('Message Admin Component', () => {
  ...
  //login
  it('Should create the Message Admin Component', () => {
    const fixture = TestBed.createComponent(MessageadminComponent);
    const app = fixture.componentInstance;
    expect(app).toBeTruthy();
  });
  
  it('Message Admin component button count check',()=>{
    const fixture = TestBed.createComponent(MessageadminComponent);
    const formElement = fixture.debugElement.nativeElement.querySelector("#MessageForm");//id selector 
    const inputElements = formElement.querySelectorAll("button");
    expect(inputElements.length).toEqual(2);
});
it('Message Admin component Form Input GUI count',()=>{
  const fixture = TestBed.createComponent(MessageadminComponent);
  const formElement = fixture.debugElement.nativeElement.querySelector("#MessageForm");//id selector 
